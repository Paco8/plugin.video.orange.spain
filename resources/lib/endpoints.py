...
endpoints = {'get-video': API_RTV + 'GetVideo?client=json&external_id={external_id}',
             ...
             'mark-position-vod': API_RTV + 'MarkPosition?video_id={video_id}&video_external_id={video_external_id}&position={position}&client=json',
             ...
             'get-elements': 'https://msn.orangetv.orange.es/pc/api/msn/v2/getElements',
