...
OUTPUT_DIR = plugin.video.orange.spain-$(VERSION)
...
install:
	...
	install -m 644 resources/*.png $(OUTPUT_DIR)/resources/
	...
	- ln -s $(OUTPUT_DIR)/ plugin.video.orange.spain-latest
...
clean:
	...
	-rm plugin.video.orange.spain-latest
